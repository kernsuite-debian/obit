% $Id: OBITdoc.tex 199 2010-06-15 11:39:58Z bill.cotton $ 
%
...
\tablekey[{"REVISION"}{E}{revision}{1.0}{}
{Revision number of the table definition.}
]
\end{keywords}
%
...
\tablecol[{"D0 POSAN"}{"DEGREE  "}{E}{(1)}{D0PosAngle}
{Deconvolved best PA}
] 
...
% Table keyword description
\begin{keywords}
\tablekey[{"REVISION"}{J}{revision}{11}{}
{Revision number of the table definition.
}
]
% Must be position 2 to index
...
\tablecol[{"DISP \#NO\_POL"}{"SECONDS "}{E}{(1)}{dispers}
{[OPTIONAL] Dispersive delay (sec at wavelength = 1m)for Poln \# NO\_POL}
] 
\tablecol[{"DDISP \#NO\_POL"}{"SEC/SEC"}{E}{(1)}{Ddispers}
{[OPTIONAL] Time derivative of DISPfor Poln \# NO\_POL}
] 
\tablecol[{"REAL\#NO\_POL"}{"       " }{E}{(numIF)}{Real}
{Real (gain Poln \# NO\_POL )}
] 
...
\tablekey[{"NO\_BACH "}{J}{numBach}{}{()}
{The number of spectral channels tabulated}
]
\tablekey[{"STRT\_CHN"}{J}{strtChn}{}{()}
...
%%%%%%%%%%%%%%% ObitTableIDI\_PHASE_CAL Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
%
\ClassName[{ObitTableIDI\_PHASE\_CAL}]
...
{This class contains tabular data and allows access.
This table is part of the IDI uv data format.
"IDI\_PHASE\_CAL" contains instrumental phase calibration data
Only FITS cataloged data are supported.
This class is derived from the ObitTable class.}
]
\tableover{
