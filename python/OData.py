...
"""
# $Id: OData.py 79 2009-03-02 17:12:23Z bill.cotton $
#-----------------------------------------------------------------------
#  Copyright (C) 2007
...
class OData(ODataPtr):
    ...
    def Zap (self, err):
        ...
        #
        self.this = Obit.ODataZap (inOData.cast(myClass), err.me)
        if err.isErr:
    ...
    def NewTable (self, access, tabType, tabVer, err, \
        ...
        if tabType=="AIPS AN":
            ...
            outTab = Obit.TableMC(id, [tabVer], access, tabType, \
                                  numPol, numBand, err.me)
