...
olong  MBDelay1Col;
/** Column offset for [OPTIONAL] Dispersive delay (sec at wavelength = 1m)for Poln # 1 in table record */
olong  dispers1Off;
/** Physical column number for [OPTIONAL] Dispersive delay (sec at wavelength = 1m)for Poln # 1 in table record */
olong  dispers1Col;
/** Column offset for [OPTIONAL] Time derivative of DISPfor Poln # 1 in table record */
olong  Ddispers1Off;
/** Physical column number for [OPTIONAL] Time derivative of DISPfor Poln # 1 in table record */
olong  Ddispers1Col;
...
olong  MBDelay2Col;
/** Column offset for [OPTIONAL] Dispersive delay (sec at wavelength = 1m)for Poln # 2 in table record */
olong  dispers2Off;
/** Physical column number for [OPTIONAL] Dispersive delay (sec at wavelength = 1m)for Poln # 2 in table record */
olong  dispers2Col;
/** Column offset for [OPTIONAL] Time derivative of DISPfor Poln # 2 in table record */
olong  Ddispers2Off;
/** Physical column number for [OPTIONAL] Time derivative of DISPfor Poln # 2 in table record */
olong  Ddispers2Col;
